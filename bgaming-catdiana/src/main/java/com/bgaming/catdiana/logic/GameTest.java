...
//                SpinResponse response = table.generateResponse(scenes, true, player.getUser().getScore());
        ...
        System.out.println("总场次: " + betCount + ", 中Bonus次数: " + bingoBonusCount + ", 概率: " + (bingoBonusCount * 1.d / betCount));
        ...
        System.out.println("总投注: " + totalBet + ", 总赢出: " + totalWin + ", 中奖概率: " + (totalWin * 1.d / totalBet) + ",bonus赢出: " + bonusWin + " , 赢出占比: " + (bonusWin * 1.d / totalWin));
