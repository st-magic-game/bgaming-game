package com.bgaming.catdiana.controller;

import com.alibaba.fastjson.JSONObject;
import com.bgaming.catdiana.entity.dto.RoundDetailDto;
import com.bgaming.catdiana.entity.dto.RoundHistoryDto;
import com.bgaming.catdiana.utils.DateTimeUtil;
import com.bgaming.catdiana.utils.JwtUtil;
...
import static com.bgaming.catdiana.config.LotteryConfig.BASE_LINE;
    ...
    public String roundDetail(@PathVariable String token, Model model) {
        ...
        try {
            ...
            if(details.size() == 1){
                ...
                roundDetailDto.setBetText(start.getBetText());
