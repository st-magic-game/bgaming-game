package com.bgaming.catdiana.entity;
...
public class Scene {
    ...
    private BigDecimal scatterWin = BigDecimal.ZERO;
    private JSONObject betLine;
    ...
    private List<List<Integer>> coins_new = new ArrayList<>();

    private List<List<Integer>> coins_new_total = new ArrayList<>();

    private List<Integer> nameIdxes = new ArrayList<>();
