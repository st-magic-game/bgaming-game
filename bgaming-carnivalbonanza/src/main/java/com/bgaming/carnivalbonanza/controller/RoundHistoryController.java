package com.bgaming.carnivalbonanza.controller;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.bgaming.carnivalbonanza.entity.log.RoundDetailDto;
import com.bgaming.carnivalbonanza.entity.log.RoundHistoryDto;
import com.bgaming.carnivalbonanza.utils.DateTimeUtil;
import com.bgaming.carnivalbonanza.utils.JwtUtil;
...
public class RoundHistoryController {
    ...
    public String history(@PathVariable String token, Model model,HttpServletRequest request) {
        ...
        model.addAttribute("gameName", "Carnival Bonanza");
