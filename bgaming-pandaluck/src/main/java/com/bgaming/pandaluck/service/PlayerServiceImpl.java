package com.bgaming.pandaluck.service;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.bgaming.pandaluck.config.LotteryConfig;
import com.bgaming.pandaluck.entity.PlayerAdditionalInformation;
import com.bgaming.pandaluck.entity.Scene;
import com.bgaming.pandaluck.entity.dto.SpinResponse;
import com.bgaming.pandaluck.mapper.PlayerAdditionalInformationMapper;
...
import static com.bgaming.pandaluck.config.LotteryConfig.BASE_LINE;
import static com.bgaming.pandaluck.config.LotteryConfig.SUB_UNITS;
...
public class PlayerServiceImpl implements IPlayerService {
    ...
    public void restorePlayerData(Player player, JSONObject gameInfo) {
        ...
        options.put("base_bet", BASE_LINE);
    ...
    private static void setBackUiData(Player player, JSONObject gameInfo, SpinResponse spinResponse) {
        if (spinResponse != null && spinResponse.getBalance() != null) {
