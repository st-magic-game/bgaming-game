...
import com.bgaming.bonanzabillion.entity.dto.StorageData;
import lombok.Data;
...
import static com.bgaming.bonanzabillion.config.LotteryConfig.COLUMNS;
import static com.bgaming.bonanzabillion.config.LotteryConfig.ROWS;
...
public class Scene {
    ...
    private List<Map<Integer,Integer>> multiIconIndexList = new ArrayList<>();
     ...
     * 图标分布
     */
    private List<int[][]> tmpRotarys = new ArrayList<>();
