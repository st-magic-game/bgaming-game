package com.bgaming.diamondofjungle.controller;

import com.alibaba.fastjson.JSONObject;
import com.bgaming.diamondofjungle.entity.dto.RoundDetailDto;
import com.bgaming.diamondofjungle.entity.dto.RoundHistoryDto;
import com.bgaming.diamondofjungle.utils.DateTimeUtil;
import com.bgaming.diamondofjungle.utils.JwtUtil;
...
public class RoundHistoryController {
    ...
    @Value("${game.gameName:Diamond Of Jungle}")
    ...
    public String roundDetail(@PathVariable String token, Model model) {
        ...
        try {
            ...
            if(details.size() == 1){
                ...
                roundDetailDto.setVolatility(start.getVolatility());
