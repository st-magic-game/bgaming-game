package com.bgaming.diamondofjungle.service;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.bgaming.diamondofjungle.entity.PlayerAdditionalInformation;
import com.bgaming.diamondofjungle.entity.Scene;
import com.bgaming.diamondofjungle.entity.dto.SpinResponse;
import com.bgaming.diamondofjungle.mapper.PlayerAdditionalInformationMapper;
...
public class PlayerServiceImpl implements IPlayerService {
    ...
    public void restorePlayerData(Player player, JSONObject gameInfo) {
        ...
        options.put("feature_options", FEATURE_OPTIONS);
        options.put("digit_options", DIGIT_OPTIONS);
