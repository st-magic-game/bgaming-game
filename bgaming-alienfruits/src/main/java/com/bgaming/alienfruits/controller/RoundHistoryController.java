package com.bgaming.alienfruits.controller;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.bgaming.alienfruits.entity.log.RoundDetailDto;
import com.bgaming.alienfruits.entity.log.RoundHistoryDto;
import com.bgaming.alienfruits.utils.DateTimeUtil;
import com.bgaming.alienfruits.utils.JwtUtil;
...
public class RoundHistoryController {
    ...
    public String history(@PathVariable String token, Model model,HttpServletRequest request) {
        ...
        model.addAttribute("gameName", "Alien Fruits");
